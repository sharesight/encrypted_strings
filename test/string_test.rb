...
class StringByDefaultTest < Minitest::Test
  def setup
...
class StringWithCustomOptionsTest < Minitest::Test
  def setup
...
class StringAfterBeingEncryptedTest < Minitest::Test
  def setup
    @encrypted_string = 'test'.encrypt
  end
...
class StringAfterBeingEncryptedAndReplacedTest < Minitest::Test
  def setup
...
class StringAfterBeingDecryptedTest < Minitest::Test
  def setup
...
class StringAfterBeingDecryptedAndReplacedTest < Minitest::Test
  def setup
    @encrypted_string = 'test'.encrypt(:symmetric, :password => 'secret')
...
class StringWithUndecryptableCipherTest < Minitest::Test
  def setup
...
class StringWithDecryptableCipherTest < Minitest::Test
  def setup
    @encrypted_string = 'test'.encrypt(:symmetric, :password => 'secret')
  end
...
class StringPreviouslyEncryptedTest < Minitest::Test
  def setup
